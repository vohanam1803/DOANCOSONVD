function win_dom() {
    ...
    p.id = "exptext";
    i = document.createTextNode(i18n.gettext("Expert"));
    p.appendChild(i);
    l.appendChild(p);
    c.appendChild(l);
    r.appendChild(c);
    ...
    a.className = "rec_txt";
    a.placeholder = i18n.gettext("Sheet");
    a.id = "s1";
    o.appendChild(a);
    ...
    //n.id = "composition";
    //n.type = "text";
    //n.placeholder = i18n.gettext("Composition's label");
    //v.appendChild(n);
    //n = document.createElement("input");
    //n.id = "submit";
    //n.type = "button";
    //n.value = i18n.gettext("Submit");
    //n.setAttribute("onclick", "alert('Soon..')");
    //v.appendChild(n);
    o.appendChild(v)
}
